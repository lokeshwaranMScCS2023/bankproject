...
function NavBar(){
    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <a className="navbar-brand px-3" href="#" data-toggle="tooltip" data-placement="bottom" title="Visit our homepage">Lokesh's Bank</a>
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                {ctx.activeUser ? (
                    ...
                    <a className="nav-item nav-link px-3" href="#/home" data-toggle="tooltip" data-placement="bottom" title="Make a deposit">Home</a>
                    ...
                    <div className="navbar-nav ml-auto">
                    <a className="nav-itenm nav-link px-3" href="#/CreateAccount" data-toggle="tooltip" data-placement="bottom" title="Create a new account">Create Account</a>
